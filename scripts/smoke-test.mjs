...
try {
  ...
  assert(runExpectFail(['memory', 'recover', '--yes']).includes('Usage: contextbook memory recover [--json]'), 'memory recover --yes should fail');
